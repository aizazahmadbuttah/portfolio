        ...
        >
            <section className="hero" id="home">
                ...
                <div className="hero-image-wrapper">
                    ...
                    <div className="profile-img-container">
                        ...
                        <div className="image-badge">AI/ML</div>
                    </div>
                </div>
            </section>
            ...
            >
                <div className="skills-header">
                    <h2 className="section-title skills-section-title">CORE <span className="skills-accent">STACK.</span></h2>
                </div>
                <div className="skills-grid skills-grid--4col">
                    <div className="skill-category">
                        <div className="skill-num-row">
                            <span className="skill-num skill-num--primary">01</span>
                        </div>
                        <h3>Frontend</h3>
                    ...
                    <div className="skill-category">
                        <div className="skill-num-row">
                            <span className="skill-num skill-num--cyan">02</span>
                        </div>
                        <h3 className="skill-h3--cyan">Backend & Databases</h3>
                        <div className="skill-tags">
                            <span className="skill-tag">.NET Core Web API</span>
                    ...
                    <div className="skill-category">
                        <div className="skill-num-row">
                            <span className="skill-num skill-num--secondary">03</span>
                        </div>
                        <h3 className="skill-h3--secondary">Languages & Tools</h3>
                        <div className="skill-tags">
            ...
            >
                <div className="gallery-heading-wrapper">
                    <div className="gallery-heading-meta">
                        ...
                        <span className="gallery-count">{projectsData.length} Projects</span>
                    </div>
                    <h2 className="section-title gallery-section-title">GALLERY <br /><span className="gallery-span">OF CODE.</span></h2>
                ...
                <motion.div layout className="projects-grid">
                    <AnimatePresence mode="popLayout">
                        {projectsData.filter(p => filter === 'All' || p.badge === filter).map((project, index) => (
                            <motion.div
                                layout
                            ...
                            >
                                ...
                                <div className="card-cover">
                                    {project.images && project.images.length > 0 ? (
                                        <img src={project.images[0].src} alt={project.images[0].alt} loading="lazy" className="card-cover-img" />
                                    ) : (
                        ...
                        <div className="contact-info-panel">
                            ...
                            <div className="contact-social">
                                ...
                                <div className="social-links">
                                    ...
                                    <a href="https://github.com/aizazahmadbuttah" target="_blank" rel="noopener noreferrer" className="social-link github" aria-label="GitHub">
